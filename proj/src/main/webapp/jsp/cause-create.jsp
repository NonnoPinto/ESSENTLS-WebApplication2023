        ...
        <div class="col-md-6">
            <div class="card text-center border-magenta">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        <form id="causeForm">
                            ...
                            <div class="input-container">
                                ...
                                <input class="form-control" type="text" name="causeName" id="causeName"
                                       placeholder="Cause name.." maxlength="255" required>
                    ...
                    <!--SUBMIT-->
                    <div>
                        <button type="submit" id="ajaxButton"
                                class="button btn bg-magenta text-white border-magenta px-4 py-2">Submit
                        </button>
                    </div>
