                                        ...
                                        <c:forEach items="${isOrganizer}" var="org" varStatus="loop">
                                            <c:if test="${org.key==event.id && org.value}">
                                                <div class="container d-flex flex-wrap zindex-modal mt-3">
                                                    <a href="eventparticipants?id=${event.id}">
                                                        <button class="button bg-blue text-white border-blue px-4 py-2 me-3 mb-3">
                                                            (Organizer) Participants List
                                                        </button>
                                                    </a>
                                                    <a href="editEvent?id=${event.id}">
                                                        <button class="button bg-blue text-white border-blue px-4 py-2 mb-3">
                                                            (Organizer) Edit
                                                        </button>
                                                    </a>
                                                </div>
