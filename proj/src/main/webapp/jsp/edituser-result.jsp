                    ...
                    <c:choose>
                        ...
                        <div class="my-2 mx-4">
                            ...
                            <div class="my-4">
                                ...
                                <p class="pb-2 border-bottom border-gray">Registration Date: ${user.registrationDate}</p>
                                ...
                                <p class="pb-2 border-bottom border-gray">Home Country Address (Street: ${user.getHomeCountryAddress().getString("street")} | Number: ${user.getHomeCountryAddress().getString("number")} | City: ${user.getHomeCountryAddress().getString("city")} | ZIP: ${user.getHomeCountryAddress().getString("zip")} | Country: ${user.getHomeCountryAddress().getString("country")})</p>
                                <p class="pb-2 border-bottom border-gray">Home Country University: ${user.homeCountryUniversity}</p>
                                ...
                                <p class="pb-2 border-bottom border-gray">Padua Address (Street: ${user.getPaduaAddress().getString("street")} | Number: ${user.getPaduaAddress().getString("number")} | City: ${user.getPaduaAddress().getString("city")} | ZIP: ${user.getPaduaAddress().getString("zip")} | Country: ${user.getPaduaAddress().getString("country")})</p>
                                <p class="pb-2 border-bottom border-gray">Document Type: ${user.documentType}</p>
                                <p class="pb-2 border-bottom border-gray">Document Number: ${user.documentNumber}</p>
                                ...
                                <p class="pb-2 border-bottom border-gray">Allergies: ${Arrays.toString(user.getAllergies())}</p>
                                <p class="pb-2 border-bottom border-gray">Email Confirmed: ${user.emailConfirmed}</p>
                            </div>
                        </div>
                        </c:otherwise>
                    </c:choose>
