                            ...
                            <div class="my-2 mx-4">
                                ...
                                <div class="my-4">
                                    ...
                                    <a href="payment?action=sub">
                                        <button class="button bg-orange text-white border-orange px-4 py-2">ONLINE</button>
                                    </a>
                                    <a href="home">
                                        <button class="button bg-orange text-white border-orange px-4 py-2">CASH</button>
                                    </a>
                                </div>
                            </div>
                        </c:otherwise>
