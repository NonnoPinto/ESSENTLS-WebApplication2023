...
/**
 * Retrieves the list of payments of the user.
 *
 * @author Andrea Campagnol
 * @version 1.00
 * @since 1.00
 */
@WebServlet(name = "UserPaymentsListServlet", value = "/userpaymentslist")
public class UserPaymentsListServlet extends AbstractDatabaseServlet{

    /**
     * Handles the HTTP {@code GET} method. Retrieves the list of payments of a user.
